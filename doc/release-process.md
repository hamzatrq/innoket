...
##perform gitian builds
 ...
 Build innoketd and innoket-qt on Linux32, Linux64, and Win32:

	./bin/gbuild --commit innoket=v${VERSION} ../innoket/contrib/gitian-descriptors/gitian-linux.yml
	./bin/gsign --signer $SIGNER --release ${VERSION} --destination ../gitian.sigs/ ../innoket/contrib/gitian-descriptors/gitian-linux.yml
	pushd build/out
	zip -r innoket-${VERSION}-linux-gitian.zip *
	mv innoket-${VERSION}-linux-gitian.zip ../../../
	popd
	./bin/gbuild --commit innoket=v${VERSION} ../innoket/contrib/gitian-descriptors/gitian-win.yml
	./bin/gsign --signer $SIGNER --release ${VERSION}-win --destination ../gitian.sigs/ ../innoket/contrib/gitian-descriptors/gitian-win.yml
	pushd build/out
	zip -r innoket-${VERSION}-win-gitian.zip *
	mv innoket-${VERSION}-win-gitian.zip ../../../
	popd
    ./bin/gbuild --commit innoket=v${VERSION} ../innoket/contrib/gitian-descriptors/gitian-osx-bitcoin.yml
