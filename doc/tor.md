...
It is possible to run Innoket as a Tor hidden service, and connect to such services.
...
The first step is running Innoket behind a Tor proxy. This will already make all
