    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Innoket Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(bool fIsTestnet)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Innoket address"));
    ...
    if (!fIsTestnet)
        aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Innoket Core"), this);
    else
        aboutAction = new QAction(QIcon(":/icons/bitcoin_testnet"), tr("&About Innoket Core"), this);
    aboutAction->setStatusTip(tr("Show information about Innoket"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Innoket"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Innoket addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Innoket addresses"));
    ...
    openAction->setStatusTip(tr("Open a innoket: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setStatusTip(tr("Show the Innoket Core help message to get a list with possible Innoket command-line options"));
...
void BitcoinGUI::createTrayIcon(bool fIsTestnet)
{
    ...
    if (!fIsTestnet)
    {
        trayIcon->setToolTip(tr("Innoket client"));
        trayIcon->setIcon(QIcon(":/icons/toolbar"));
    }
    else
    {
        trayIcon->setToolTip(tr("Innoket client") + " " + tr("[testnet]"));
...
void BitcoinGUI::gotoLoggerPage()
{
    ...
    if (walletFrame) walletFrame->gotoLoggerPage();
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Innoket network", "", count));
}
...
{
    QString strTitle = tr("Innoket"); // default title
