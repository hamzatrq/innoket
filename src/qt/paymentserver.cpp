...
const char* BITCOIN_REQUEST_MIMETYPE = "application/innoket-paymentrequest";
const char* BITCOIN_PAYMENTACK_MIMETYPE = "application/innoket-paymentack";
const char* BITCOIN_PAYMENTACK_CONTENTTYPE = "application/innoket-payment";
    ...
    if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // innoket: URI
    {
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
                ...
                emit message(tr("URI handling"),
                    tr("URI can not be parsed! This can be caused by an invalid Innoket address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
