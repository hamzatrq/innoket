...
/* *** BEGIN DARKSEND MAGIC - DASH **********
    Copyright (c) 2014-2015, Innoket Developers
        eduffield - evan@innoketpay.io
        udjinm6   - udjinm6@innoketpay.io
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Innoket and make it unusable. To
