...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("seed3.innoket.org", "seed3.innoket.org"));
        vSeeds.push_back(CDNSSeedData("seed4.innoket.org", "seed4.innoket.org"));
        vSeeds.push_back(CDNSSeedData("seed5.innoket.org", "seed5.innoket.org"));
        vSeeds.push_back(CDNSSeedData("seed6.innoket.org", "seed6.innoket.org"));
        vSeeds.push_back(CDNSSeedData("seed7.innoket.org", "seed7.innoket.org"));
        vSeeds.push_back(CDNSSeedData("seed8.innoket.org", "seed8.innoket.org"));
