...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Innoket Core", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Innoket Core</b> version", 0));
...
"Copyright &copy; 2014-YYYY The Innoket Core developers.", 0));
